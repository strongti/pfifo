...
public:
    ...
    typedef std::function<void(const CommonAPI::CallStatus&)> SendImage1AsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&)> SendImage2AsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&)> SendImage3AsyncCallback;
    typedef std::function<void(const CommonAPI::CallStatus&)> SendImage4AsyncCallback;

    virtual void sendImage1(std::vector< uint8_t > _image1, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
    ...
    virtual void sendImage2(std::vector< uint8_t > _image2, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
    ...
    virtual void sendImage3(std::vector< uint8_t > _image3, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
    ...
    virtual void sendImage4(std::vector< uint8_t > _image4, CommonAPI::CallStatus &_internalCallStatus, const CommonAPI::CallInfo *_info = nullptr) = 0;
